...
from sklearn.metrics import precision_score, recall_score, \
    roc_auc_score, accuracy_score, f1_score, average_precision_score, balanced_accuracy_score
...
def get_eval_metrics(pred_label, pred_probs, true_label, all_label):
    ...
    rec = recall_score(true_m, pred_m, average='weighted')
    f1 = f1_score(true_m, pred_m, average='weighted')
    auc = roc_auc_score(true_m, pred_m_auc, average='weighted')
    prc = average_precision_score(true_m, pred_m_auc, average='weighted')
    acc = accuracy_score(true_m, pred_m)
